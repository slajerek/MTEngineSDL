...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden -DDARWIN_NO_CARBON   -I/usr/local/Cellar/libpng/1.6.37/include/libpng16 \
...
# Linker flags.
#
LDFLAGS           :=  -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.37/lib -lpng16 -lz
