...
#include "gzguts.h"
#include <unistd.h>  /* local patch (carried from 1.2.5 vendoring): read/write/lseek/close
                        prototypes; Windows resolves this via platform/Windows/src.Windows/unistd.h */
