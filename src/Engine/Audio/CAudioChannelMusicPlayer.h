...
{
public:
	CAudioChannelMusicPlayerPlaylistItem(CSlrMusicFile *music, u8 playlistMode);
	CSlrMusicFile *music;
	u8 playlistMode;
...
public:
	...
	void Play();
	void Pause();
	CAudioChannelMusicPlayerPlaylistItem *AddToPlaylist(CSlrMusicFile *music, u8 playlistMode, u8 playMode);
	void PlaylistTick();
	void PlaylistStep();
