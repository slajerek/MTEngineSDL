...
CGuiViewDataTable::CGuiViewDataTable(float posX, float posY, float posZ, float sizeX, float sizeY)
...
void CGuiViewDataTable::Render(float posX, float posY)
{
	CGuiView::Render(posX, posY);
}

//@returns is consumed
bool CGuiViewDataTable::DoTap(float x, float y)
{
...
bool CGuiViewDataTable::DoFinishTap(float x, float y)
{
...
//@returns is consumed
bool CGuiViewDataTable::DoDoubleTap(float x, float y)
{
	LOGG("CGuiViewDataTable::DoDoubleTap:  x=%f y=%f", x, y);
	return CGuiView::DoDoubleTap(x, y);
}

bool CGuiViewDataTable::DoFinishDoubleTap(float x, float y)
{
	LOGG("CGuiViewDataTable::DoFinishTap: %f %f", x, y);
...
bool CGuiViewDataTable::DoMove(float x, float y, float distX, float distY, float diffX, float diffY)
{
...
bool CGuiViewDataTable::FinishMove(float x, float y, float distX, float distY, float accelerationX, float accelerationY)
{
...
bool CGuiViewDataTable::DoZoomBy(float x, float y, float zoomValue, float difference)
{
