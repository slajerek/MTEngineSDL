...
// ANSI-C strings
#define CSTRALLOC(point)		strdup((point))
//str_dup((point))
#define CQUICKLINK(point)	str_dup((point))
#define CQUICKMATCH(p1, p2)	strcmp((p1), (p2)) == 0
#define CSTRFREE(point)						\
do								\
{								\
if (!(point))							\
{								\
...
#define EMPTY_PATH_ALLOC(var) { var = new char[MAX_PATH]; var[0] = 0x00; }
