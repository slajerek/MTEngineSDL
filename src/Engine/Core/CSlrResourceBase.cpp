...
void CSlrResourceBase::ResourceSetPriority(u8 newPriority)
{
	this->resourcePriority = newPriority;
}

void CSlrResourceBase::ResourceSetPath(const char *path, bool fromResources)
{
...
bool CSlrResourceBase::ResourcePreload(const char *fileName, bool fromResources)
{
...
const char *CSlrResourceBase::ResourceGetTypeName()
{
