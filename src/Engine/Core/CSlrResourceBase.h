...
#define RESOURCE_STATE_ERROR		1
#define RESOURCE_STATE_PRELOADING	2
...
public:
	...
	void ResourceSetPath(const char *path, bool fromResources);
	char *ResourceGetPath();
	
	virtual const char *ResourceGetTypeName();
	virtual const char *ResourceGetStateName();
