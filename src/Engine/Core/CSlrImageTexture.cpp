...
void CSlrImageTexture::Render(float destX, float destY, float z, float sizeX, float sizeY)
{
#if defined(CHECK_IF_NOT_ACTIVE_AND_LOAD)
	if (this->CheckIfActive() == false)
		return;
...
void CSlrImageTexture::Render(float destX, float destY, float z, float size,
...
void CSlrImageTexture::RenderAlpha(float destX, float destY, float z, float alpha)
{
#if defined(CHECK_IF_NOT_ACTIVE_AND_LOAD)
	if (this->CheckIfActive() == false)
		return;
...
void CSlrImageTexture::RenderAlpha(float destX, float destY, float z, float sizeX,
...
void CSlrImageTexture::RenderAlphaMixColor(float destX, float destY, float z, float sizeX,
...
void CSlrImageTexture::RenderAlpha(float destX, float destY, float z, float size,
							float texStartX, float texStartY,
...
void CSlrImageTexture::RenderAlpha(float destX, float destY, float z,
...
void CSlrImageTexture::Render(float destX, float destY, float z,
								   float sizeX, float sizeY,
								   float texStartX, float texStartY,
								   float texEndX, float texEndY)
{
...
void CSlrImageTexture::RenderAlpha_aaaa(float destX, float destY, float z, float sizeX, float sizeY,
								 float texStartX, float texStartY,
								 float texEndX, float texEndY,
								 float alpha)
{
...
void CSlrImageTexture::RenderAlphaColor(float destX, float destY, float z, float sizeX, float sizeY,
								 float texStartX, float texStartY,
								 float texEndX, float texEndY,
...
void CSlrImageTexture::RenderPolygonAlpha(float alpha, float *verts, float *texs, float *norms, unsigned int numVertices)
{
#if defined(CHECK_IF_NOT_ACTIVE_AND_LOAD)
	if (this->CheckIfActive() == false)
		return;
...
void CSlrImageTexture::RenderPolygonMixColor(float mixColorR, float mixColorG, float mixColorB, float mixColorA, float *verts, float *texs, float *norms, unsigned int numVertices)
{
#if defined(CHECK_IF_NOT_ACTIVE_AND_LOAD)
	if (this->CheckIfActive() == false)
		return;
...
void CSlrImageTexture::RenderFlipHorizontal(float destX, float destY, float z, float sizeX, float sizeY)
{
#if defined(CHECK_IF_NOT_ACTIVE_AND_LOAD)
	if (this->CheckIfActive() == false)
		return;
...
void CSlrImageTexture::DelayedLoadImage(const char *fileName, bool fromResources)
{
...
const char *CSlrImageTexture::ResourceGetTypeName()
{
	return "texture";
}
