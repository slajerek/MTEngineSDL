...
CConfigStorage::CConfigStorage(bool fromResources, const char *fileName)
{
...
CConfigValue *CConfigStorage::GetConfigValue(const char *name)
{
...
bool CConfigStorage::GetBoolValue(const char *name, bool def)
{
...
float CConfigStorage::GetFloatValue(const char *name, float def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
int CConfigStorage::GetIntValue(const char *name, int def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::GetStringValue(const char *name, char *value, int numChars, const char *def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::SetBoolValue(const char *name, bool def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::SetFloatValue(const char *name, float def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::SetIntValue(const char *name, int def)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::SetStringValue(const char *name, char *value, int numChars)
{
	CConfigValue *v = GetConfigValue(name);
	if (v == NULL)
	{
...
void CConfigStorage::DumpToFile(const char *filePath)
{
