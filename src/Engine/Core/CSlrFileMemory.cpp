...
CSlrFileMemory::CSlrFileMemory(bool fromResources, const char *fileName, u8 fileType)
{
...
CSlrFileMemory::CSlrFileMemory(u8 *data, u32 size)
{
	this->Open(data, size);
}
...
void CSlrFileMemory::Open(bool fromResources, const char *fileName, u8 fileType)
{
...
void CSlrFileMemory::Open(u8 *data, u32 size)
{
...
void CSlrFileMemory::ReloadFileMemory()
{
	...
	this->memFileData = new u8[this->fileSize];
	file->Read(memFileData, this->fileSize);
	delete file;
}

u8 *CSlrFileMemory::GetFileMemoryData(u32 *fileSize)
{
...
u32 CSlrFileMemory::Read(u8 *data, u32 numBytes)
{
	...
	u8 *copyPointer = this->memFileData + this->filePos;
