...
CGuiButtonMenu::CGuiButtonMenu(CSlrImage *image, float posX, float posY, float posZ, float sizeX, float sizeY, u8 alignment, CGuiButtonCallback *callback)
...
CGuiButtonMenu::CGuiButtonMenu(char *text, bool blah, float posX, float posY, float posZ, float sizeX, float sizeY, u8 alignment, CGuiButtonCallback *callback)
...
CGuiButtonMenu::CGuiButtonMenu(CSlrImage *image, float posX, float posY, float posZ, float sizeX, float sizeY, u8 alignment,
...
bool CGuiButtonMenu::DoTap(float x, float y)
{
...
bool CGuiButtonMenu::DoFinishTap(float x, float y)
{
...
bool CGuiButtonMenu::DoFinishDoubleTap(float x, float y)
{
	return DoFinishTap(x, y);
}


bool CGuiButtonMenu::DoMove(float x, float y, float distX, float distY, float diffX, float diffY)
{
...
bool CGuiButtonMenu::FinishMove(float x, float y, float distX, float distY, float accelerationX, float accelerationY)
{
//	if (this->isExpanded
