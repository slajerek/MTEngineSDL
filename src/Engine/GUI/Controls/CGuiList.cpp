...
CGuiList::CGuiList(float posX, float posY, float posZ, float sizeX, float sizeY, float fontSize,
...
bool CGuiList::DoMove(float x, float y, float distX, float distY, float diffX, float diffY)
{
	if (!visible)
		return false;
...
bool CGuiList::FinishMove(float x, float y, float distX, float distY, float accelerationX, float accelerationY)
{
	if (!visible)
		return false;
...
bool CGuiList::DoZoomBy(float x, float y, float zoomValue, float difference)
{
	if (!visible)
		return false;
...
void CGuiList::MoveView(float diffX, float diffY)
{
	if (!visible)
		return;
...
bool CGuiList::DoTap(float x, float y)
{
	LOGD("CGuiList::DoTap");
...
bool CGuiList::DoDoubleTap(float x, float y)
{
	if (!visible)
		return false;
