...
CGuiEditBoxFloat::CGuiEditBoxFloat(float posX, float posY, float posZ, float fontWidth, float fontHeight,
...
bool CGuiEditBoxFloat::KeyPressed(u32 keyCode, bool isShift, bool isAlt, bool isControl, bool isSuper)
{
