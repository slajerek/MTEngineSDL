...
CGuiLabel::CGuiLabel(CSlrImage *image, float posX, float posY, float  posZ, float  sizeX, float  sizeY, u8 alignment, CGuiLabelCallback *callback)
...
CGuiLabel::CGuiLabel(char *text, bool stretched, float  posX, float  posY, float  posZ, float  sizeX, float  sizeY, u8 alignment, float  fontWidth, float  fontHeight, CGuiLabelCallback *callback)
: CGuiElement(posX, posY, posZ, sizeX, sizeY)
{
...
CGuiLabel::CGuiLabel(CSlrString *textUTF, float  posX, float  posY, float  posZ, float  sizeX, float  sizeY, u8 alignment, CSlrFont *font, float  fontSize, CGuiLabelCallback *callback)
...
CGuiLabel::CGuiLabel(CSlrString *textUTF, float  posX, float  posY, float  posZ, float  sizeX, float  sizeY, u8 alignment, CSlrFont *font, float  fontSize, float colorR, float colorG, float colorB, float alpha, CGuiLabelCallback *callback)
: CGuiElement(posX, posY, posZ, 1.0f, 1.0f)
{
	this->name = "CGuiLabel:Text";
	this->beingClicked = false;
...
CGuiLabel::CGuiLabel(CSlrString *textUTF, float  posX, float  posY, float  posZ, float  sizeX, float  sizeY, u8 alignment, CSlrFont *font, float  fontScale,
...
void CGuiLabel::SetFontSize(float fs)
{
	this->fontSize = fs;
	this->fontWidth = fs;
	this->fontHeight = fs;
...
void CGuiLabel::SetPosition(float  posX, float  posY, float  posZ, float  sizeX, float  sizeY)
{
...
void CGuiLabel::Render(float  posX, float  posY)
{
	if (this->visible)
	{
		if (this->image != NULL)
...
// @returns is consumed
bool CGuiLabel::DoTap(float  posX, float  posY)
{
...
bool CGuiLabel::DoFinishTap(float  posX, float  posY)
{
	if (this->transparentToTaps)
		return false;
...
// @returns is consumed
bool CGuiLabel::DoDoubleTap(float  posX, float  posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiLabel::DoFinishDoubleTap(float  posX, float  posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiLabel::Clicked(float  posX, float  posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiLabel::Pressed(float  posX, float  posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiLabel::DoMove(float  x, float  y, float  distX, float  distY, float  diffX, float  diffY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiLabel::FinishMove(float  x, float  y, float  distX, float  distY, float  accelerationX, float  accelerationY)
{
	if (this->transparentToTaps)
		return false;
