...
CGuiRichTextLabel::CGuiRichTextLabel(char *text, float posX, float posY, float posZ, float sizeX, float sizeY, float scale, CGuiRichTextLabelCallback *callback)
...
CGuiRichTextLabel::CGuiRichTextLabel(CSlrString *text, float posX, float posY, float posZ, float sizeX, float sizeY, float scale, CGuiRichTextLabelCallback *callback)
: CGuiElement(posX, posY, posZ, sizeX, sizeY)
{
	this->callback = callback;
...
void CGuiRichTextLabel::SetParameters(CSlrFont *font, float scale, float r, float g, float b, float a, u8 alignment)
{
	this->SetParametersNoParse(font, scale, r, g, b, a, alignment);
	this->Parse();
}

void CGuiRichTextLabel::SetParametersNoParse(CSlrFont *font, float scale, float r, float g, float b, float a, u8 alignment)
{
...
void CGuiRichTextLabel::SetPosition(float posX, float posY, float posZ, float sizeX, float sizeY)
{
	CGuiElement::SetPosition(posX, posY, posZ, sizeX, sizeY);
	this->Parse();
}

void CGuiRichTextLabel::SetPositionNoParse(float posX, float posY, float posZ, float sizeX, float sizeY)
{
	CGuiElement::SetPosition(posX, posY, posZ, sizeX, sizeY);
}
...
void CGuiRichTextLabel::Render(float posX, float posY)
{
	PushMatrix2D();
...
// @returns is consumed
bool CGuiRichTextLabel::DoTap(float posX, float posY)
{
...
bool CGuiRichTextLabel::DoFinishTap(float posX, float posY)
{
	if (this->transparentToTaps)
		return false;
...
// @returns is consumed
bool CGuiRichTextLabel::DoDoubleTap(float posX, float posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiRichTextLabel::DoFinishDoubleTap(float posX, float posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiRichTextLabel::Clicked(float posX, float posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiRichTextLabel::Pressed(float posX, float posY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiRichTextLabel::DoMove(float x, float y, float distX, float distY, float diffX, float diffY)
{
	if (this->transparentToTaps)
		return false;
...
bool CGuiRichTextLabel::FinishMove(float x, float y, float distX, float distY, float accelerationX, float accelerationY)
{
	if (this->transparentToTaps)
		return false;
...
CGuiRichTextLabelElement::CGuiRichTextLabelElement(float x, float y, float z, float textWidth, float fontHeight, float spaceWidth, float gapHeight, u8 alignment, u8 blinkMode, float blinkParamMin, float blinkParamMax, u32 blinkParamNumFrames)
{
	this->type = RICH_TEXT_LABEL_ELEMENT_TYPE_UNKNOWN;
...
CGuiRichTextLabelElementText::CGuiRichTextLabelElementText(CSlrString *str, CSlrFont *font, float x, float y, float z, float r, float g, float b, float a, float scale,
		float fontHeight, float spaceWidth, float gapHeight, u8 alignment, u8 blinkMode, float blinkParamMin, float blinkParamMax, u32 blinkParamNumFrames)
{
...
{
	//BlitTextColor(CSlrString *text, float posX, float posY, float posZ, float size, float colorR, float colorG, float colorB, float alpha)
...
CGuiRichTextLabelElementImage::CGuiRichTextLabelElementImage(CSlrImage *image,
		...
		float spaceWidth, float gapHeight, u8 alignment, u8 blinkMode, float blinkParamMin, float blinkParamMax, u32 blinkParamNumFrames)
{
...
CGuiRichTextLabelElementLineBreak::CGuiRichTextLabelElementLineBreak(float fontHeight, float spaceWidth, float gapHeight, u8 alignment,
																	 u8 blinkMode, float blinkParamMin, float blinkParamMax,
