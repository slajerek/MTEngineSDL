...
class CViewAudioMixer : public CGuiView
{
public:
	CViewAudioMixer(const char *name, float posX, float posY, float posZ, float sizeX, float sizeY, std::list<CAudioChannel *> *audioChannels);
	virtual ~CViewAudioMixer();
