...
#define PLATFORM_KMOD_CTRL      SDL_KMOD_CTRL
#define PLATFORM_KMOD_LCTRL     SDL_KMOD_LCTRL
#define PLATFORM_KMOD_RCTRL     SDL_KMOD_RCTRL
#define PLATFORM_KMOD_GUI       SDL_KMOD_GUI
#define PLATFORM_KMOD_LGUI      SDL_KMOD_LGUI
#define PLATFORM_KMOD_RGUI      SDL_KMOD_RGUI
